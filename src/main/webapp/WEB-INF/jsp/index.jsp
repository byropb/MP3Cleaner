                ...
                <table id='fieldoptions' style='display: none; position: fixed;'>
                  ...
                  <tr>
                    <td>
                      <div>
                        <div id="checkboxes">
                          <label for="trak"><input type="checkbox" id="trackOption" name="trackOption" />Track </label> <label for="title">
                            <input type="checkbox" name="titleOption" id="titleOption" />Title
