...
<body onload="body_onload();">
  ...
  <form id='mp3cleaner' name='mp3cleaner' target="_self" method='post' action="do_rename" 
  onsubmit="form_onsubmit();"  th:object="${mp3Model.extensions}" >
          ...
          <table class='tab_form'>
            <tr>
              ...
              <td colspan='2'><input type='text' id='path' name='path' required='required'
                ...
                value='${mp3Model.path}'  onchange="path_onchange();"
                placeholder='C:/<path to files directory>'
              /></td>
            </tr>
            <tr>
              <td class='label'>Files type:</td>
              <td>
              <select name="filetype" id="filetype" required='required' style='width: 30%' onchange="path_onchange();">
            ...
            <tr>
              ...
              <td><input type='text' id='newFileName' required='required' name='newFileName' id='newFileName'
                title='new file sequence name' placeholder='new files sequence name' value='${mp3Model.newFileName}'
              /></td>
            </tr>
            <tr>
              <td class='label'>Starting Sequence#:</td>
              <td>
              <input type='number' id='startCount' name='startCount' required='required' style='width: 30%'
                title='Starting index of file sequence' value='${mp3Model.startCount}'
                placeholder='Starting index of file sequence'/>
              </td>
            </tr>
            <tr>
              <td colspan='3'>
            ...
            <tr>
              <td><input type='button' value='to dashboard' onclick="showObject('myModal'); toDashboard('mp3cleaner');"
                class='button' title='go to dashboard'
              /></td>

              <td style='text-align: center'>&nbsp;</td>

              <td style='text-align: right'><input type='submit' title='rename all files in directory'
                value='rename files' class='button'
              /></td>
            </tr>
          </table>
        </td>
